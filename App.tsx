...
const App: React.FC = () => {
        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden relative">
            ...
            <div className="glass-card w-full max-w-md p-10 rounded-[4rem] text-center relative z-10 animate-in fade-in zoom-in-95 duration-1000 shadow-[0_0_100px_rgba(30,58,138,0.4)] border border-blue-400/20">
                <button 
                  ...
                  className="mb-10 flex justify-center group active:scale-95 transition-all duration-500"
                >
                ...
                <p className="font-magic text-sm tracking-[0.5em] text-cyan-400 mb-14 uppercase font-bold opacity-90 drop-shadow-[0_0_8px_rgba(34,211,238,0.6)]">Blue Fantasy Lounge</p>
                ...
                <div className="space-y-8 text-left mb-4">
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            <input 
                                type="text" 
                                placeholder="ID or Mobile Crystal"
                                className="w-full bg-slate-950/50 border-2 border-blue-900/50 rounded-3xl px-8 py-6 focus:ring-8 focus:ring-blue-500/10 focus:border-cyan-500/50 outline-none text-white font-bold text-xl transition-all duration-500 placeholder:text-blue-900/40"
                                value={loginInput}
                            ...
                            <button 
                              ...
                              className="absolute right-4 top-1/2 -translate-y-1/2 p-3 bg-blue-900/80 text-cyan-400 rounded-2xl hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-lg border border-blue-400/20"
                            >
                    ...
                    <button 
                        onClick={handleLogin} 
                        className="w-full btn-magic text-white font-cinzel py-6 rounded-3xl text-sm font-black tracking-[0.2em] uppercase flex items-center justify-center gap-4 shadow-[0_20px_40px_-10px_rgba(29,78,216,0.5)] border border-blue-400/20 hover:scale-[1.02] active:scale-95 transition-all"
                    >
    ...
    const renderAdminLogin = () => (
        <div className="flex flex-col items-center justify-center min-h-screen p-6 relative">
            ...
            <div className="glass-card w-full max-w-md p-10 rounded-[3rem] text-center animate-in slide-in-from-bottom-12 duration-700 relative z-10 border border-blue-400/20">
                <div className="w-20 h-20 bg-blue-900/30 backdrop-blur-xl rounded-3xl flex items-center justify-center text-cyan-400 mx-auto mb-8 border border-blue-500/20 shadow-2xl">
    ...
    const renderAdminRegister = () => (
        <div className="flex flex-col items-center justify-center min-h-screen p-6">
            <div className="glass-card w-full max-w-md p-10 rounded-[3rem] text-center animate-in zoom-in-95 duration-500 border border-blue-400/20">
                ...
                <form onSubmit={handleAdminRegister} className="space-y-4 mb-8">
                    ...
                    <button className="w-full btn-magic text-white py-5 rounded-2xl font-black text-xs uppercase tracking-widest mt-2">Bind Oath</button>
                </form>
        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-6">
            <div className="glass-card w-full max-w-md p-10 rounded-[3rem] text-center animate-in zoom-in-95 duration-500 border border-blue-400/20">
                ...
                <form onSubmit={handleAdminReset} className="space-y-4 mb-8">
                    ...
                    <button className="w-full btn-magic text-white py-5 rounded-2xl font-black text-xs uppercase tracking-widest mt-2">Reforge Key</button>
                </form>
            ...
            <div className="min-h-screen p-4 pb-24 max-w-lg mx-auto animate-in fade-in duration-1000 relative">
                ...
                <div className="mb-14 relative z-10">
                    ...
                    <div className="mt-8 flex justify-center gap-4">
                        <button onClick={() => setPreviewCustomer(currentCustomer)} className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-blue-300 hover:text-cyan-400 transition-colors bg-white/5 px-6 py-3 rounded-2xl border border-white/5"><Download className="w-4 h-4"/> Save Identity</button>
                    </div>
                </div>
                ...
                <div className="glass-card rounded-[3rem] p-10 relative overflow-hidden z-10 border border-blue-400/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                    <div className="flex justify-between items-center mb-12">
                        ...
                        <div className="bg-blue-600/20 px-5 py-2 rounded-full text-[11px] font-black border border-blue-500/30 shadow-lg text-blue-100">{currentCustomer.stamps} / 5</div>
                    </div>
                ...
                {currentCustomer.stamps === 5 && (
                    <div className="mt-10 bg-gradient-to-br from-blue-600 via-indigo-700 to-cyan-800 p-10 rounded-[3rem] flex items-center gap-8 shadow-[0_30px_60px_-15px_rgba(29,78,216,0.5)] border border-cyan-400/40 animate-pulse relative z-10 overflow-hidden group">
                        <div className="absolute top-0 left-0 w-full h-full bg-white/5 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
                        ...
                        <div>
                            ...
                            <h4 className="font-cinzel text-3xl font-black text-white uppercase tracking-tighter leading-none">Free Snack Unlocked</h4>
                        </div>
                    </div>
                )}
            </div>
                ...
                <main className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10 relative z-10">
                    <div className="glass-card rounded-[3.5rem] p-10 h-fit shadow-2xl border border-blue-400/10">
                        ...
                        <form onSubmit={handleAddCustomer} className="space-y-6">
                            ...
                            <button className="w-full btn-magic text-white py-6 rounded-3xl font-black text-[11px] uppercase tracking-[0.2em] mt-4 shadow-2xl border border-blue-400/10">Enlist Magician</button>
                        </form>
                    </div>
                    ...
                    <div className="lg:col-span-2 glass-card rounded-[3.5rem] overflow-hidden flex flex-col min-h-[650px] shadow-2xl border border-blue-400/10 backdrop-blur-2xl">
                        <div className="p-8 border-b border-blue-900/20 flex items-center gap-6 bg-slate-900/20 backdrop-blur-md">
                            <div className="relative flex-1 group">
                                ...
                                <input 
                                    type="text" 
                                    placeholder="Scry magical archives for members..." 
                                    className="w-full bg-slate-950/60 border-2 border-blue-900/30 rounded-[2rem] pl-16 pr-8 py-5 text-white placeholder-blue-900/40 focus:border-cyan-500 outline-none transition-all text-lg font-bold" 
                                    value={searchQuery} 
                                    ...
                                    {filtered.map(c => (
                                        <tr key={c.id} className="hover:bg-blue-900/10 transition-colors group/row">
                                            ...
                                            <td className="px-10 py-8 text-center">
                                                {c.stamps === 5 ? (
                                                    <button 
                                                      ...
                                                      className="bg-cyan-600 text-white text-[10px] px-6 py-3 rounded-full font-black uppercase tracking-widest hover:bg-cyan-500 hover:scale-105 transition-all shadow-2xl border border-white/10"
                                                    >
                                                      Claim Feast
                                                    </button>
                                                ) : (
                                            ...
                                            <td className="px-10 py-8 text-right">
                                                <div className="flex justify-end gap-4 opacity-40 group-hover/row:opacity-100 transition-opacity duration-300">
                                                    ...
                                                    <button onClick={() => { if(confirm('Exile this magician to the archives?')) storageService.deleteCustomerSoft(c.id); setCustomers(storageService.getCustomers()); }} className="p-3 text-red-500 bg-red-950/20 border border-red-900/40 rounded-xl hover:bg-red-600 hover:text-white transition-all shadow-lg"><Trash2 className="w-5 h-5" /></button>
                                                </div>
                                            </td>
                                        </tr>
                                    ))}
                    ...
                    <div className="fixed inset-0 z-[100] bg-slate-950/90 backdrop-blur-2xl flex items-center justify-center p-6 animate-in fade-in duration-300">
                        <div className="max-w-md w-full relative animate-in zoom-in duration-500">
                            ...
                            <div className="mt-12 text-center space-y-6">
                                <h3 className="font-cinzel text-2xl text-white tracking-widest uppercase drop-shadow-lg">Ancient Identity Scroll</h3>
                                <div className="flex gap-4">
                                    <button onClick={() => { alert('Digital Scroll captured and saved to library!'); setPreviewCustomer(null); }} className="flex-1 btn-magic py-5 rounded-2xl text-white font-black uppercase text-xs tracking-[0.2em] flex items-center justify-center gap-3 shadow-[0_15px_30px_rgba(29,78,216,0.4)] border border-blue-400/20">
                                        <Download className="w-5 h-5" /> Save Scroll
                                    </button>
                                    <button onClick={() => setPreviewCustomer(null)} className="flex-1 bg-slate-900 border border-blue-900/50 py-5 rounded-2xl text-blue-300 font-black uppercase text-xs tracking-widest hover:bg-blue-900 transition-all">Close</button>
                                </div>
                            </div>
                        </div>
                    </div>
